...
/* package add-0.1.0.0 */
#ifndef VERSION_add
#define VERSION_add "0.1.0.0"
#endif /* VERSION_add */
#ifndef MIN_VERSION_add
#define MIN_VERSION_add(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_add */
...
#define CURRENT_PACKAGE_KEY "add-0.1.0.0-DrimPxKPNoh9BVD9tPAjsv"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "add-0.1.0.0-DrimPxKPNoh9BVD9tPAjsv"
